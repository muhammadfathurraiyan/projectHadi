...
const index = () => {
  return (
    <section className="relative -top-1 flex flex-col justify-center items-center bg-green-500 py-24 px-24 max-md:px-12 max-sm:px-8">
      <div>
      ...
      <div className="absolute left-0 -bottom-[78px] w-full overflow-hidden">
        <svg
          data-name="Layer 1"
