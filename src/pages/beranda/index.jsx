...
const Beranda = () => {
  return (
    ...
    >
      <div className="flex justify-normal px-24 max-md:px-12 max-sm:px-8 h-full items-center max-md:flex-col max-md:items-start max-md:justify-center p-12 bg-black/50 w-[65%] max-md:w-full">
        <div className="">
